...
class PaymentTransactions {
  ...
  async authorizeCreditCard(
    ...
    creditCard.setCardNumber(transactionRequest.payment.creditCard?.cardNumber);
    creditCard.setExpirationDate(transactionRequest.payment.creditCard?.expirationDate);
    creditCard.setCardCode(transactionRequest.payment.creditCard?.cardCode);
  ...
  async capturePreviouslyAuthorizedAmount(
    ...
    // Implementation for capturing a previously authorized amount
  }
  ...
  async refundTransaction(
    ...
    // Implementation for refunding a transaction
  }

  async voidTransaction(
    transactionRequest: TransactionRequest
  ): Promise<TransactionResponse> {
    // Implementation for voiding a transaction
  }

  // Additional methods for other types of payment transactions
}
